...
2. leer `docs/THREAD_ARCHITECTURE.md` cuando exista y sea aplicable;
3. inspeccionar la rama actual y el estado de Git;
4. leer el/los informe(s) actual(es) del proyecto;
5. inspeccionar cualquier documento de handoff específico de la tarea;
6. identificar la versión vigente de la documentación y los commits relevantes;
7. inspeccionar la implementación y los tests existentes antes de proponer cambios;
8. informar de cualquier documento referenciado que falte en lugar de inventar su contenido.
...
## 6. Informes, arquitectura y handoffs
...
Un handoff debe entenderse como transferencia de responsabilidad, no como simple lista de tareas.

## 7. Protocolo de responsabilidad y alcance
...
## 8. Protocolo de cierre de cada hilo sustantivo
...
## 9. Reglas de trazabilidad y evidencia
...
## 10. Datos raw / processed / derived
...
## 11. Principios Station, Location y Evidence
...
## 14. Estado documentado actual del proyecto
